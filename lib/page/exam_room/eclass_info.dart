...
class EclassInfo extends StatefulWidget {
  static const routeName = '/eclassInfo';
  const EclassInfo({Key? key}) : super(key: key);

  @override
  State<EclassInfo> createState() => _EclassInfoState();
}

class _EclassInfoState extends State<EclassInfo> {
  @override
                                  ...
                                  children: [
                                    ...
                                    Row(
                                      children: [
                                        ...
                                        Text(
                                          controller.examModel.examStudent[0]
                                              .studentMail
                                              .toString(),
